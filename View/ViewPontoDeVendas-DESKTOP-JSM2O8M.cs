...
namespace PDV.View
{
    public partial class ViewPontoDeVendas : Form
    {
        ...
        public ViewPontoDeVendas(string caixa)
        {
            InitializeComponent();
        ...
        private void tbQuantidade_KeyDown_1(object sender, KeyEventArgs e)
        {
            ...
            {
                ViewFormaPagamento view = new ViewFormaPagamento(tbPrecoTotal.Text, carrinho,labelCaixa.Text); // MOSTRAR O VALOR Q ESTAVA NO TEXTBOX DO FRENTE DE CAIXA NO LABEL DO FORM "FINALIZAR VENDA"
                view.ShowDialog();
            }
